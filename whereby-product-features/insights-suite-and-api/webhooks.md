...
* `assistant.requested`: Sent when a host invites a Whereby Assistant into their room. See the [Whereby Assistants documentation](../../reference/assistant-sdk-reference/) for more information.
...
<table><thead><tr><th width="374">Property</th><th>Description</th></tr></thead><tbody><tr><td><code>displayName</code></td><td>The visible name displayed to others in the meeting.</td></tr><tr><td><code>roomSessionId</code></td><td>The <code>roomSessionId</code> for the meeting.</td></tr><tr><td><code>participantId</code></td><td>The current user's <code>participantId</code>. Can be used for insights data.</td></tr><tr><td><a href="../../whereby-for-web-browser/web-component-and-pre-built-ui/configuring-with-attributes.md#metadata-less-than-string-greater-than"><code>metadata</code></a></td><td>String that matches the "<a href="../../whereby-for-web-browser/web-component-and-pre-built-ui/configuring-with-attributes.md#metadata-less-than-string-greater-than">metadata</a>" query parameter passed to the room URL.</td></tr><tr><td><a href="../../whereby-for-web-browser/web-component-and-pre-built-ui/configuring-with-attributes.md#externalid-less-than-id-greater-than"><code>externalId</code></a></td><td>String that matches the "<a href="../../whereby-for-web-browser/web-component-and-pre-built-ui/configuring-with-attributes.md#externalid-less-than-id-greater-than">externalId</a>" query parameter passed to the room URL.</td></tr></tbody></table>
