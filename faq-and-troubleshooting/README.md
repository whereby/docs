...
Yes! When using our [Embed Element](../create-your-video-experience-with-the-whereby-sdk/in-a-web-page/using-the-whereby-embed-element/) or [Embed SDK](../tbd-archive/whereby-embedded-sdk-beta.md#browser-sdk), you'll have access to "leave" browser event. You can then action on that event to redirect your users to another page of your choosing.
