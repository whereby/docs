...
{% hint style="info" %}
**Note**: To use the API, you’ll need to [create an API key](../getting-started/overview-of-whereby-embedded/initial-setup.md#id-2.-generate-an-api-key). A new key is generated from the “Configure” section in the Embedded dashboard. Your API key is secret and should only be used from your server.
{% endhint %}
