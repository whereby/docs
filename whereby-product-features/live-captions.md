---
description: >-
  Live Captions (or closed captions) provide AI-powered, real-time text
  representation of spoken content during events within a meeting room, such as
  presentations, meetings, or videos.
---
...
To do so, create the room with [POST /meetings](../reference/whereby-rest-api-reference/meetings.md#post-meetings) request and specify the live caption configuration. It's a sub-property of the `liveTranscription` object.
