...
For a full overview of available in-room functionality refer to the [RoomConnectionClient reference pages](../../core-sdk-reference/api-reference/roomconnectionclient/).
{% endhint %}
