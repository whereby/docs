...
|   [<mark style="color:blue;">`?avatarUrl=<url>`</mark>](using-url-parameters.md#avatarurl-less-than-url-greater-than) <mark style="color:blue;">``</mark>  | Set the profile avatar of participant.                                                                                        |
