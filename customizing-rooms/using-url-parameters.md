...
| ``[`?roomIntegrations=on`](https://docs.whereby.com/customizing-rooms/using-url-parameters#roomintegrations)`` | Enables YouTube and Miro integrations in the meeting                 |
