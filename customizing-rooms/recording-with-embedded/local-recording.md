...
3. You've enabled Local Recording from the “Configure” → “Recording” section of your dashboard. Or you've set the recording type to <mark style="color:blue;">`local`</mark> during the API request.
