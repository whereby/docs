...
Read more about [creating rooms using the API](../creating-and-deleting-rooms/using-the-rest-api.md), and refer to our [API reference](../whereby-rest-api-reference/) for further details.
