---
description: >-
  Waiting rooms are a great way for your hosts to manage meeting access with
  ease.
---
...
2. Add a unique background image for the waiting room precall flow with our [API endpoint](../reference/whereby-rest-api-reference/rooms.md#put-rooms-roomname-theme-room-knock-page-background)
...
<figure><img src="../.gitbook/assets/host-knock.png" alt="" width="375"><figcaption><p>Host controls seen in the "People" tab</p></figcaption></figure>
