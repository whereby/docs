...
For this migration, you'll be utilizing our [Web Component](../../reference/using-the-whereby-embed-element.md) to integrate Whereby rooms into your platform. While this is likely different than your existing Twilio setup, it requires **significantly less code and design time** as it leverages Whereby's existing PWA and our UI/UX.

It may not offer the complete customization you'd initially be looking for, but we've collaborated with customers that have made this migration in a matter of days instead of weeks. After you've got a 1.0 launch with Whereby under your belt, you can start considering a more custom integration method utilizing our [React Hooks](../../reference/react-hooks-reference/)
...
Create roomUrl's via [POST request to our REST API](https://app.gitbook.com/s/c7hN8ZKHNZris5300KEl/reference/whereby-rest-api-reference#meetings)
