...
{% hint style="info" %}
If you aren't using a bundler or a library containing a bundler you can access the component code directly from our CDN using a [simple Script tag](../whereby-101/create-your-video-experience/in-a-web-page/using-the-whereby-embed-element/script-tags.md) in your site
{% endhint %}
