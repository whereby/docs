---
description: >-
  Screen sharing is a great way to share content to other hosts/participants in
  the room.
---
...
* Enabling screen sharing for all rooms via a [dashboard preference](dashboard-preferences/)
