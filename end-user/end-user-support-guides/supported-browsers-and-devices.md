...
{% hint style="warning" %}
Due to a bug in Safari for macOS, we've temporarily disabled our [Picture in Picture](../../whereby-product-features/screen-sharing.md#picture-in-picture) feature for versions 17.x
{% endhint %}
