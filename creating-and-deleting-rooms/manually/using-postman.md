...
{% hint style="info" %}
**Note**: To use the API, you’ll need to [create an API key](../../tbd-archive/creating-an-api-key.md). A new key is generated from the “Configure” section in the Embedded dashboard. Your API key is secret and should only be used from your server.
{% endhint %}
